 ...
 */
@Service("beautyUserService")
public class BeautyUserService extends UserService {
    ...
    public UserTO reg(UserTO user, String deviceId) throws CommonException, LoginException {
        user.setRegProduct(ProductType.BEAUTY);
        //验证码检验
    ...
    public UserTO activate(UserTO user) throws CommonException {
        ...
        bean.setProduct(ProductType.BEAUTY);
